...
CREATE TABLE `lt_users` (
  ...
  `user_registered` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '用户注册时间，datetime值。',
...
insert  into `lt_users`(`ID`,`user_login`,`user_pass`,`user_nicename`,`user_email`,`user_url`,`user_registered`,`user_activation_key`,`user_status`,`display_name`) values (1,'zhanzhiqiang','123456','詹之蔷','953720113@qq.com','','2018-03-06 23:37:16','',0,'詹之蔷'),(2,'zhanz01','123456','占占','953720113@qq.com','','2018-04-03 16:46:53','',0,'');
...
) ENGINE=InnoDB AUTO_INCREMENT=981093907858735107 DEFAULT CHARSET=utf8 COMMENT='系统用户表';

/*Data for the table `sys_user` */

insert  into `sys_user`(`id`,`name`,`age`,`type`,`ctime`) values (784972358981328902,'Tom',24,127,'2018-03-03 00:00:00'),(784972358981328903,'Jammy',21,127,'2018-03-04 00:00:00'),(981090649945714690,'zhanzhiqiang',12,1,'2018-04-03 16:46:53'),(981093907858735106,'zhanzhiqiang01',12,1,'2018-04-03 16:59:50');
