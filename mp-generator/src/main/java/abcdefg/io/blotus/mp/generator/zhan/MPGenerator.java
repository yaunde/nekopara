package abcdefg.io.blotus.mp.generator.zhan;
...
public class MPGenerator {
	...
	public static void main(String[] args) {
		...
		String path = MPGenerator.class.getResource("/").getPath();
...
//		gc.setOutputDir("D://out");
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/lotus?useUnicode=true&amp;characterEncoding=UTF-8&amp;generateSimpleParameterMetadata=true");
		dsc.setUsername("root");
		dsc.setPassword("335100");
		...
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		 strategy.setInclude(new String[] { "lt_users", "lt_posts", "lt_comments" }); // 需要生成的表
		// strategy.setExclude(new String[]{"test"}); // 排除生成的表
		mpg.setStrategy(strategy);

		// 包配置
		PackageConfig pc = new PackageConfig();
		pc.setParent("io.blotus");
		//pc.setModuleName("");
