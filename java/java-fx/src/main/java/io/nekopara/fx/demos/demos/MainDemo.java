package io.nekopara.fx.demos.demos;
...
import io.nekopara.fx.demos.main.MainController;
    ...
    public void start(Stage stage) throws Exception {
        new Thread(() -> {
            try {
                ...
                System.out.println(MainDemo.class.getResourceAsStream("/fonts/icomoon.svg"));
